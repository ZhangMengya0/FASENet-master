...
from .network.decoder import build_decoder,build_decoder2
from .network.intersection import build_erase
import torch
from .network.dinknet import BAM_LinkNet50,BAM_LinkNet50_T,LinkNet50_T
from .network.swin_transformer import SwinTransformer
...
class SwinT_OAM(nn.Module):
    def __init__(self):
        ...
        self.finalconv = nn.Conv2d(int(filters[0]/4),2,1)
    def forward(self,x):
        x4 = self.backboon(x)
        e4 = x4[3]
        e3 = x4[2]
