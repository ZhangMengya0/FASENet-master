...
from model.comparison.networks.res2net import res2net50
from model.comparison.networks.resnet import resnet50
from model.comparison.networks.cabm_resnet import ResidualNet
from model.comparison.networks.intersection import build_erase
...
class LinkNet50_T(nn.Module):
    ...
    def forward(self, x):
        ...
        return e1,e2,e3,e4
from model.comparison.networks.swin_transformer import SwinTransformer
