...
from segmentation_ir.model.DSCNet import DSConv
...
class StripUnet(nn.Module):  # strip-unet
    def __init__(self, num_classes=2):
        ...
        # 512*3
        self.firstconv = resnet.conv1  # 256*64
        self.firstbn = resnet.bn1
        self.firstrelu = resnet.relu
        self.firstmaxpool = resnet.maxpool  # 128*64

        self.encoder1 = resnet.layer1  # 128*64
        self.encoder2 = resnet.layer2  # 64*128
        self.encoder3 = resnet.layer3  # 32*256
        self.encoder4 = resnet.layer4  # 16*512

        self.msff = MSFF(512)

        self.dam1 = DAM(128, 64)   # 128*64
        self.dam2 = DAM(64, 128)   # 64*128
        self.dam3 = DAM(32, 256)    # 32*256
        self.dam4 = DAM(16, 512)   # 16*512
        ...
        self.finaldeconv1 = nn.ConvTranspose2d(filters[0], 32, 4, 2, 1)  # 512*32
        self.finalrelu1 = nonlinearity
        self.finalconv2 = nn.Conv2d(32, 32, 3, padding=1)  # 1024*32
        self.finalrelu2 = nonlinearity
        self.finalconv3 = nn.Conv2d(32, num_classes, 3, padding=1)  # 1024*2
